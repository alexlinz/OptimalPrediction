...
#Split variables
echo $1 > variables.txt
location=$(awk -F'+' '{print $1}' variables.txt)
method=$(awk -F'+' '{print $2}' variables.txt)

# Copy data
cp /mnt/gluster/amlinz/NTL-MO/$location .
